...
public class TestClient {
    public static void main(String[] args) {
        ...
        try {
            ...
            EndpointReference targetEPR = new EndpointReference("http://localhost:8080/Axis2HelloWorld/services/TestService");
             ...
             *
             */
            QName qname = new QName("http://demo.tianyao.com", "test");
